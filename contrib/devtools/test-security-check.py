...
class TestSecurityChecks(unittest.TestCase):
    ...
    def test_PE(self):
        ...
        # https://github.com/lief-project/LIEF/issues/1076
        ...
        self.assertEqual(call_security_check(cxx, source, executable, pass_flags + ['-Wl,--disable-dynamicbase']), (1, executable + ': failed PIE DYNAMIC_BASE')) # -pie -fPIE does nothing without --dynamicbase
